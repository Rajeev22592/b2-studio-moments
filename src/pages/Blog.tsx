...
const Blog = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Blog & Case Studies | B2 Studio Photography</title>
        <meta name="description" content="Explore photography tips, wedding inspiration, and success stories from B2 Studio. Read our case studies showcasing exceptional wedding, fashion, and corporate photography work." />
        <meta name="keywords" content="wedding photography blog, photography tips, case studies, wedding inspiration, fashion photography, corporate events, B2 Studio" />
        <link rel="canonical" href="https://b2studio.com/blog" />
        <meta property="og:title" content="Blog & Case Studies | B2 Studio Photography" />
        <meta property="og:description" content="Explore photography tips, wedding inspiration, and success stories from B2 Studio." />
