...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about B2 Studio - From passion to profession. Our team of creative professionals combines technical expertise with artistic vision to deliver exceptional photography and cinematography services.',
  openGraph: {
    title: 'About B2 Studio - Professional Photography & Cinematography',
    description: 'Learn about B2 Studio - From passion to profession. Our team of creative professionals combines technical expertise with artistic vision.',
  },
};
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="fade-in">
                <div className="relative">
                  <img 
                    src={typeof photographerPortrait === 'string' ? photographerPortrait : (photographerPortrait as any)?.src || photographerPortrait || '/src/assets/photographer-portrait.jpg'}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="fade-in">
                <div className="relative">
                  <img 
                    src={typeof photographerPortrait === 'string' ? photographerPortrait : photographerPortrait.src || '/src/assets/photographer-portrait.jpg'}
                    alt="Rahul Sharma - Lead Photographer"
