...
export const metadata: Metadata = {
  title: 'Portfolio',
  description: 'Explore B2 Studio\'s stunning photography portfolio. Browse our galleries featuring weddings, portraits, events, commercial, product, fashion, and travel photography.',
  keywords: ['photography portfolio', 'wedding photos', 'portrait photography', 'event photography', 'commercial photography', 'fashion photography'],
  openGraph: {
    title: 'Portfolio | B2 Studio Photography - Wedding, Fashion & Event Photography',
    description: 'Explore B2 Studio\'s stunning photography portfolio. Browse our galleries featuring weddings, portraits, events, commercial, product, fashion, and travel photography.',
  },
};
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {categories.map((category, index) => {
                const imageSrc = typeof category.image === 'string' ? category.image : category.image.src || category.image;
                return (
                  <Link
                    key={category.id}
